!(function (t) {
  ...
  function n(e) {
    const endPoint = document.head.querySelector("meta[name='end-point']").content
    1 == t("#light-mode-switch").prop("checked") && "light-mode-switch" === e
      ? (t("html").removeAttr("dir"),
        ...
        t("#bootstrap-style").attr("href", endPoint+"/backend/assets/css/bootstrap.min.css"),
        t("#app-style").attr("href", endPoint+"/backend/assets/css/app.min.css"),
        sessionStorage.setItem("is_visited", "light-mode-switch"))
      : 1 == t("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e
      ? (t("html").removeAttr("dir"),
        t("#light-mode-switch").prop("checked", !1),
        t("#rtl-mode-switch").prop("checked", !1),
        t("#bootstrap-style").attr("href", endPoint+"/backend/assets/css/bootstrap-dark.min.css"),
        t("#app-style").attr("href", endPoint+"/backend/assets/css/app-dark.min.css"),
        sessionStorage.setItem("is_visited", "dark-mode-switch"))
      : 1 == t("#rtl-mode-switch").prop("checked") &&
        "rtl-mode-switch" === e &&
        (t("#light-mode-switch").prop("checked", !1),
        t("#dark-mode-switch").prop("checked", !1),
        t("#bootstrap-style").attr("href", endPoint+"/backend/assets/css/bootstrap-rtl.min.css"),
        t("#app-style").attr("href", endPoint+"/backend/assets/css/app-rtl.min.css"),
        t("html").attr("dir", "rtl"),
