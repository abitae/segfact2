    ...
    <div class="col-12">
      <div class="page-title-box">
        <div class="page-title">
          <h4 class="mb-0 font-size-18">Asignar permisos</h4>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript: void(0);">Full tecnología</a></li>
            <li class="breadcrumb-item"><a href="javascript: void(0);">Administrar</a></li>
            <li class="breadcrumb-item active select-none">Asignar permiso</li>
          </ol>
        </div>
      </div>
    </div>
...
@section('content')
  <div class="page-content-wrapper">
    ...
    <assign-permission-component
      ...
      can-update-role="{{ auth()->user()->can('update roles') }}"
    ></assign-permission-component>
  </div>
@endsection
