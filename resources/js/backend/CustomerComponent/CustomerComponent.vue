        ...
        <div class="card">
          <div class="card-body">
            <div style="min-height: 300px;">
              ...
              <form @submit.prevent="getListDataCustomers()" class="row">
              ...
              <div v-if="listDataCustomers.total > 0 && can(canView)" class="col-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover table-bordered">
                    ...
                    <tbody class="vertical-align-middle">
                      <tr v-for="(customer,index) in listDataCustomers.data" :key="index">
                        <td class="options" v-if="can(canEdit, canUpdateStatus)">
                          <button
                            v-if="can(canEdit)"
                            class="btn btn-sm btn-primary"
                            @click="openModalEditCustomer(customer)"
                  ...
                  <pagination class="select-none"
                    ...
                    @pagination-change-page="getListDataCustomers"
                  >
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title select-none" id="Modal para registrar proveedores"> {{ modalTitle }} Cliente </h5>
...
<script src="./CustomerComponent.js"></script>
