<template>
  <div>
            ...
            <div style="min-height: 300px;">
              <div class="card-title select-none title-with-button">
                ...
                <button
                  ...
                  @click="openModalCreateEnterprise">
                  <i class="fas fa-plus"></i> Nuevo
                </button>
              </div>
              <form @submit.prevent="getListDataEnterprise()" class="row">
              ...
              <div v-if="listDataEnterprises.total > 0 && can(canView)" class="col-12">
                <div class="table-responsive">
                  <table class="table table-sm table-hover table-bordered">
                    ...
                    <tbody class="vertical-align-middle">
                      <tr v-for="(customer,index) in listDataEnterprises.data" :key="index">
                        <td class="options" v-if="can(canEdit, canUpdateStatus)">
                          <button
                            v-if="can(canEdit)"
                            class="btn btn-sm btn-primary"
                            @click="openModalEditUser(customer)"
                  ...
                  <pagination class="select-none"
                    :limit="5"
                    size="small"
                    :data="listDataEnterprises"
                    @pagination-change-page="getListDataEnterprise"
                  >
    ...
    <div class="modal fade" id="modal-enterprise" tabindex="-1" aria-labelledby="Modal para registrar empresa" aria-modal="true" role="dialog">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title select-none" id="Modal para registrar empresa"> {{ modalTitle }} empresa </h5>
          ...
          <div class="modal-body">
            ...
            <div class="row" v-if="typeDocument">
              ...
              <div class="mb-3 col-12 col-md-6 col-lg-4">
                <label class="form-label" for="idEnterpriseMyCompany">Código de MyCompany</label>
                <input v-model="idEnterpriseMyCompany" class="form-control" type="number" id="idEnterpriseMyCompany" autocomplete="off">
              </div>
              <div class="col-sm-12">
                <h6 class="text-primary">CONFIGURACIÓN DE DOCUMENTOS</h6>
              </div>
              <div class="mb-3 col-12 col-md-12">
                <label class="form-label" for="representative_name">Representante</label>
                <input v-model="representative_name" class="form-control" type="text" id="representative_name" autocomplete="off" placeholder="Complete este campo...">
              </div>
              <div class="mb-3 col-12 col-md-12 col-lg-4">
                <label class="form-label" for="representative_dni">Representante DNI</label>
                <input v-model="representative_dni" class="form-control" type="text" id="representative_dni" autocomplete="off" placeholder="Complete este campo...">
              </div>
              <div class="mb-3 col-12 col-md-12 col-lg-4">
                <label class="form-label" for="nro_cuenta_interbancaria">N° Cuenta Interbancaria</label>
                <input v-model="nro_cuenta_interbancaria" class="form-control" type="text" id="nro_cuenta_interbancaria" autocomplete="off" placeholder="Complete este campo...">
              </div>
              <div class="mb-3 col-12 col-md-12 col-lg-4">
                <label class="form-label" for="nro_cuenta_detraction">N° Cuenta detración</label>
                <input v-model="nro_cuenta_detraction" class="form-control" type="text" id="nro_cuenta_detraction" autocomplete="off" placeholder="Complete este campo...">
              </div>
            </div>
          </div>
...
<script src="./EnterpriseComponent.js"></script>
