...
Route::group(['middleware' => ['auth']], function () {
  ...
  Route::get('/mycompany', 'MyCompanyController@index')->name('mycompany');
  Route::get('/newMyCompany', 'MyCompanyController@store')->name('newMyCompany');
  Route::get('/newMyCompany/{mc}', 'MyCompanyController@update')->name('updateMyCompany');
});
